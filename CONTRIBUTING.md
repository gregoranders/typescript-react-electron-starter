...
Contributing to `typescript-react-electron-starter` is fairly easy. This document shows you how to
get the project, run all provided tests and generate a production-ready build.

It also covers provided tasks that help you develop with `typescript-react-electron-starter`.
...
To get the source of `typescript-react-electron-starter`, clone the git repository via:
...
- Commit your changes
  ...
  - typescript-react-electron-starter uses [generate-changelog](https://www.npmjs.com/package/generate-changelog), so please make sure your commits follow the [conventions](https://docs.google.com/document/d/1QrDFcIiPjSLDn3EL15IJygNPiHORgU1_OOAqWjiDU5Y/edit)
